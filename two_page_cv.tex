...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength-180pt}p{\rcollength+180pt}}
    ...
    \href{http://debjyoti385.github.io/AirQuality/}{AirQuality} & \hspace{0.5cm}  (Goldman Sachs Hackathon Runners Up) This analyze the air quality of Utah state from real world dataset. Data warehousing and cubing to enable interactive visualization framework, which helped in determining pattern of Pollution and its reason. \\
