...
\begin{document}
\makeheading{\Large{Debjyoti Paul} {\color{blue}\small\hspace{12.3cm} December, 2022}}
% \vspace{-1cm}
%
% \vspace{.3cm}
...
Database Optimization, Large-Scale Data Analytics, Representation Learning, Spatio-Temporal Data, \\Natural Language Processing, Speech Technologies, Representation Learning.
%
...
\begin{tabular}[t]{@{}p{24pt}p{\rcollength+200pt}}
        ...
        Advisor  &: \href{}{\em Late Prof.  Sanjeev K Aggarwal}\\
...
\item[] Responsible for creating, improving, and deploying state-of-the-art automated speech recognition, Inverse Text Normalization and other companion multi-modal models.
\end{outerlist}
\vspace{1mm}

\textbf{[Aug 2015 - Jan 2020] University of Utah., Research Assistant}, Salt Lake City, United States
\vspace{-2mm}
\begin{outerlist}
\item[] Built a large-scale and efficient spatio-temporal data analytics framework.\vspace{-2.5mm}
\item[] Temporal data summarization: Historical or back-in-time bursty event detection. \vspace{-2.5mm}
\item[] Cloud database optimization and workload-aware database tuning with ML/AI.\vspace{-2.5mm}
\item[] Spatial data enrichment: Semantic representation for region of interest.
\end{outerlist}
\vspace{1mm}
...
{\em \textbf{Data-Driven Spatio-Temporal Analysis for Multimode Data.}} \href{https://drive.google.com/file/d/1Vjb9bzxK9AYemO8OxEqVZn6_MRKf7FuP/view?usp=share_link}{\texttt{[PDF]}}|\href{https://drive.google.com/file/d/1TL1O0nDr-_u2LuSbIt7lRS9fldHEuzp-/view?usp=share_link}{\texttt{[PPT]}}\\
...
{\em \textbf{Multi-constraint Job scheduling in Grid Computing.}} \href{https://drive.google.com/file/d/19cuytbIOSVN3ukVFEUICh5ZneFlh5L7l/view?usp=share_link}{\texttt{[PDF]}}|\href{https://drive.google.com/file/d/1PhpgjvtPBjc2dfeTXZmP6g6xszaxHYN_/view?usp=share_link}{\texttt{[PPT]}}\\
% \vspace{0.05cm}\\
...
\\
\begin{bibsection}
\item[+] Language Agnostic Data-Driven Inverse Text Normalization, Szu-Jui Chen, \textbf{Debjyoti Paul}, Yutong Pang, Peng Su, Xuedong Zhang. \textit{ICASSP 2023}. \textit{(In Submission)}.
\item[+] Improving Data Driven Inverse Text Normalization using Data Augmentation and Machine Translation,  \textbf{Debjyoti Paul}, Yutong Pang, Sray Chen, Xuedong Zhang, \href{https://www.isca-speech.org/archive/interspeech_2022/paul22_interspeech.html}{\emph{Interspeech 2022 Show and Tell}, Incheon, Korea, September 2022.}
\item[+] Improving Data Driven Inverse Text Normalization using Data Augmentation, Laxmi Pandey, \textbf{Debjyoti Paul}, Pooja Chitkara, Yutong Pang, Xuedong Zhang et al. \href{https://arxiv.org/abs/2207.09674}{CS arXiv:2207.09674} (2022).
\item[+] Database Workload Characterization with Query Plan Encoders, \textbf{Debjyoti Paul}, Jie Cao, Feifei Li, Vivek Srikumar, {\em 48th International Conference on Very Large Data Bases (VLDB 2022)}, Sydney, Australia, 2022. \textit{DOI: \href{https://doi.org/10.14778/3503585.3503600}{10.14778/3503585.3503600}}
...
\item[\textbf{[2018-2023]}] Reviewer: EDBT 2016, PVLDB (2019, 2021), IEEE TKDE (2018, 2019, 2020), IEEE ICDE 2021, ICASSP 2023.
\item[\textbf{[2015-2019]}] Teaching Mentor and Lecture: Natural Language Processing (CS6340), Data Mining (CS 6140), Database Systems (CS 6530) at the University of Utah. USA.
...
% \href{https://www.debjyotipaul.in/\#projects}{\scriptsize (For~ more...  {\scriptsize \faHome/\#projects)}}
}
\begin{tabular}[t]{@{}>{\raggedright\arraybackslash}p{\textwidth-\rcollength-150pt}p{\rcollength+150pt}}
        {Workload Script} ~~~~\href{https://bit.ly/3hxClcb}{\scriptsize\texttt{git:bit.ly/3hxClcb}} & \hspace{0.5cm} This script automates installs of PostgreSQL, PostGIS 2.4, OLTP and OLAP benchmark on cloud instances. It also downloads and prepares respective benchmarks on cloud database instances with multiple database configurations. Additionally, it continuously uploads all the execution stats and metrics to a data collection server. This script is essential for database tuning research and training data generation. \\[0.1cm]
        {OSM Benchmark} ~~~~\href{https://bit.ly/3PF1DS7}{\scriptsize\texttt{git:bit.ly/3PF1DS7}} & \hspace{0.5cm} OSM is a database benchmark based on Open Street map dataset on Los Angeles, Salt Lake City and New York counties and cities containing spatial queries on multipolygons, points, and nearest neighbors.\\[0.1cm]
        {Jackpine} ~~~~\href{http://bit.ly/3hxBKHt}{\scriptsize\texttt{git:bit.ly/3hxBKHt}} & \hspace{0.5cm} JackPine is a geospatial database benchmark with updated support from PostGIS and updated shapefiles dataset.It contains spatial queries on multipolygons, lines, points and spatial joins among these combinations.\\[0.1cm]
        \href{https://github.com/InitialDLab/AIPro}{\sc AI Pro} ~~~~~~~~~~~~~~\href{http://bit.ly/3YA7vQT}{\scriptsize\texttt{git:bit.ly/3YA7vQT}} ~~~~\href{http://bit.ly/3WlRLii}{\scriptsize\texttt{demo:bit.ly/3WlRLii}} & \hspace{0.5cm} AI Pro is a framework for large scale Spatio-temporal Sentiment Analysis on social data. Example projects supported by Compass: Popularity of Political Parties for the Presidential Election 2016, Social Media indicators and social health outcomes. Read publications for details.\\[0.1cm]
        Event Aggregator ~~~~~~~~~\href{https://bit.ly/3Gb4qj7}{\scriptsize\texttt{git:bit.ly/3Gb4qj7}}& \hspace{0.5cm}  This project finds events from news articles, categorize them and gathers all articles talking about same event to a set. Each set of articles is referred as Event Entity. Information extraction process is applied to extract more information related to it. The code can process large scale data. The code will be made public later. \\[0.1cm]
        ...
        % \href{http://github.com/debjyoti385/intelliad}{Intelliad} ~~~~~~~~~\href{https://goo.gl/UAnEdz}{\scriptsize\texttt{git:goo.gl/UAnEdz}} & \hspace{0.5cm} A Social Media driven Intelligent Ad-Targeting framework using Geo-profiling. The idea is to tag all geo-location enabled tweets(available publicly) with semantic categories (say sports, politics etc.) and their sentiment (positive, neutral, negative) using text mining. To enable serving of Ads, they also need to be tagged using same categories based on their content. \\[0.2cm]
        % \href{http://debjyoti385.github.io/AirQuality/}{AirQuality} ~~~~\href{https://bit.ly/3v0hLUU}{\scriptsize\texttt{git:bit.ly/3v0hLUU}}  & \hspace{0.5cm}  Goldman Sachs Hackathon - This analyze the air quality of Utah state from real world dataset. Data warehousing and cubing to enable interactive visualization framework, which helped in determining pattern of Pollution and its reason. \\
\end{tabular}
\begin{tabular}[t]{@{}>{\raggedright\arraybackslash}p{\textwidth-\rcollength-150pt}p{\rcollength+150pt}}
...
\end{tabular}
\textit{Find more projects at \href{https://www.debjyotipaul.in/}{https://www.debjyotipaul.in/}}
...
\begin{innerlist}
\item[\textbf{[2015-2016]}] \textbf{Ph.D. Fellowship} at University of Utah.
\item[\textbf{[2013]}] Ranked 3rd out of 39 M.Tech students of CSE department in Indian of Institute Technology, Kanpur
\item[\textbf{[2012]}]  Secured \textbf{All India Rank 228} out of 160,000+ (99.85 percentile) participants in Graduate Aptitude Test for Engineering (GATE) 2012, Computer Science.
...
\item[\textbf{[2011]}] \textbf{All India Rank 7} (99.99 percentile) in Indian Space Research Organization (ISRO) Junior Research Fellow Exam.
...
\item[\textbf{[2010]}] 2nd Rank in Manual Robo-race competition and 2nd Rank in Robo-Olympics an innovative track based racing competition in Bits to Bytes Tech-fest, Bengal Institute of Technology.
\end{innerlist}
...
\vspace{-2mm}
\begin{outerlist}
\item[] Chief Database Scientist, Director, Alibaba Group, China. \vspace{-2mm}
\item[] Ex-Professor, University of Utah, USA. \vspace{-2mm}
\item[] Email: \href{mailto:lifeifei@cs.utah.edu}{\texttt{lifeifei@cs.utah.edu}}, \href{mailto:ricosfeifei@gmail.com}{\texttt{ricosfeifei@gmail.com}}
\end{outerlist} \vspace{1mm}
\textbf{~2. Jeff M Phillips}
\vspace{-2mm}
\begin{outerlist}
\item[] Associate Professor, School of Computing, University of Utah, USA \vspace{-2mm}
\item[] Email: \href{mailto:jeffp@cs.utah.edu}{\texttt{jeffp@cs.utah.edu}}
\end{outerlist} \vspace{1mm}
\textbf{~3. Quynh C. Nguyen}
\vspace{-2mm}
\begin{outerlist}
\item[] Associate Professor, Epidemiology and Biostatistics, University of Maryland, USA. \vspace{-2mm}
\item[] Email: \href{mailto:qtnguyen@umd.edu}{\texttt{qtnguyen@umd.edu}}
\end{outerlist} \vspace{1mm}
\textbf{~4. Vivek Srikumar}
\vspace{-2mm}
\begin{outerlist}
    \item[] Associate Professor, School of Computing, University of Utah, USA. \vspace{-2mm}
    \item[] Email: \href{mailto:svivek@cs.utah.edu}{\texttt{svivek@cs.utah.edu}}
\end{outerlist}
\vspace{1mm}
