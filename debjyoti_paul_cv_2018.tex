...
%        \href{http://debjyoti385.github.io/AirQuality/}{AirQuality} -\href{https://goo.gl/F8twhn}{\textit{https://goo.gl/F8twhn}}  & \hspace{0.5cm}  Goldman Sachs Hackathon - This analyze the air quality of Utah state from real world dataset. Data warehousing and cubing to enable interactive visualization framework, which helped in determining pattern of Pollution and its reason. \\
        ...
        \href{http://github.com/debjyoti385/intelliad}{Intelliad} \href{https://goo.gl/UAnEdz}{\textit{goo.gl/UAnEdz}} & \hspace{0.5cm} A Social Media driven Intelligent Ad-Targeting framework using Geo-profiling. The idea is to tag all geo-location enabled tweets(available publicly) with semantic categories (say sports, politics etc.) and their sentiment (positive, neutral, negative) using text mining. To enable serving of Ads, they also need to be tagged using same categories based on their content. \\[0.1cm]
      \href{http://metonym.in}{Metonym (metonym.in)} & \hspace{1cm}  A synonym based vocabulary learner website built with d3.js, php and dropwizard framework at the backend. \\[0.1cm] %For demo use username: "demo" \& password: "12345678"  \\
...
\\
\textbf{[2012] Microsoft Research}, \emph{Summer School on Distributed Computing}, Bangalore, India\\
\textbf{[2010] Jadavpur University,} \emph{System Administration}, Kolkata, India\\
