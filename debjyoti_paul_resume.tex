...
\begin{tabular}[t]{@{}p{24pt}p{\rcollength+200pt}}
        ...
        Thesis   &: \emph{Spatio-temporal Data Analysis, Prediction \& its Applications. } \\
        GPA      &: {\em 3.94/4.0} \\[5pt]
\end{tabular}
\vspace{0.1cm}
...
{\em \textbf{Spatio-temporal Data Analysis, Prediction \& its Applications.}(In Progress)}\\
% \vspace{0.05cm}\\
 The objective is to explore the possibilities of using spatio-temporal data efficiently for learning crowd behaviour in social engagement, health care and through upsurging events.\vspace{0.1cm}\\
% \vspace{0.05cm}\\
