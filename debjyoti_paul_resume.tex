...
\begin{document}
\makeheading{\Large{Debjyoti Paul} {\color{blue}\small\hspace{12.7cm} January, 2022}}
% \vspace{-1cm}
%
% \vspace{.3cm}
...
\\
\begin{bibsection}
\item[+] Improving Data Driven Inverse Text Normalization using Data Augmentation, Laxmi Pandey, \textbf{Debjyoti Paul}, Pooja Chitkara, Yutong Pang, {\em ACL ARR 2022} (In Review).
