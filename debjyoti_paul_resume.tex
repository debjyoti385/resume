...
% \end{tabular}
\begin{tabular}[t]{@{}p{\textwidth-\rcollength }p{\rcollength}}
\faEnvelope ~ \href{mailto:debjyotipaul385@gmail.com}{\url{debjyotipaul385@gmail.com}}  & \faHome ~ \href{http://www.cs.utah.edu/~deb}{\url{www.cs.utah.edu/\~deb}}  \\
        % Salt Lake City   & \faEnvelope ~ \href{mailto:deb@cs.utah.edu}{\url{deb@cs.utah.edu}}\\
...
\\
\begin{bibsection}
\item[+] Semantic Embedding for Regions of Interest, \textbf{Debjyoti Paul}, Feifei Li, Jeff M. Phillips, \emph{The International Journal on Very Large Data Bases (VLDBJ 2021).} [To Appear]\href{https://www.dropbox.com/s/qc2o39kz029wkxb/SemanticEmbeddingOfRegions_VLDBJ_20.pdf?dl=0}{[PDF]}
