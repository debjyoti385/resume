...
\begin{document}
\makeheading{\Large{Debjyoti Paul} {\color{blue}\small\hspace{12.4cm} February, 2023}}
% \vspace{-1cm}
%
% \vspace{.3cm}
...
\item[\textbf{[2016-2023]}] Reviewer: ISCA Interspeech 2023, ICASSP 2023, IEEE ICDE 2021, PVLDB (2019, 2021), IEEE TKDE (2018, 2019, 2020),  EDBT 2016,
