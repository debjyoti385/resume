...
\begin{document}
\makeheading{\Large{Debjyoti Paul} {\color{blue}\small\hspace{12.3cm} November, 2023}}
% \vspace{-1cm}
%
% \vspace{.3cm}
...
% \end{tabular}
\begin{tabular}[t]{@{}p{\textwidth-\rcollength-55}p{\rcollength-55}p{55}}
\faEnvelope ~ \href{mailto:dr.debjyotipaul@gmail.com}{\url{dr.debjyotipaul@gmail.com}} & \faLinkedin ~ \href{https://www.linkedin.com/in/debjyotipaul385/}{\url{debjyotipaul385}} & \aiGoogleScholar ~~ \href{https://scholar.google.com/citations?user=xSy7SxUAAAAJ&hl=en}{\url{xSy7SxUAAAAJ}} \\
        % Salt Lake City   & \faEnvelope ~ \href{mailto:deb@cs.utah.edu}{\url{deb@cs.utah.edu}}\\
        \faHome ~ \href{http://www.debjyotipaul.in}{\url{debjyotipaul.in}} & \faGithub ~ \href{https://github.com/debjyoti385}{\url{debjyoti385}} & \aiResearchGate ~ \href{https://www.researchgate.net/profile/Debjyoti-Paul/research}{\url{debjyoti-paul}}
        % ZIP: 84102  &  \faLinkedin ~ \href{https://www.linkedin.com/in/debjyotipaul385/}{\url{/in/debjyotipaul385/}} \\
        % University of Utah & \faGithub ~ \href{https://github.com/debjyoti385}{\url{www.github.com/debjyoti385}} \\
        % USA     &  \faPhone ~ \texttt{+1 385 E1E-7219} \\
\end{tabular}
...
Spatio-temporal Data Analytics, Database Tuning, Natural Language Processing, \\Speech Technologies, Representation Learning.
%
...
\\
\begin{bibsection}
\item[+] Recovering from Privacy-Preserving Masking with Large Language Models, Arpita Vats, Zhe Liu, Peng Su, \textbf{Debjyoti Paul}, Yingyi Ma, Yutong Pang, Zeeshan Ahmed, Ozlem Kalinli. {\emph{(In Review.)}
\item[+] Language Agnostic Data-Driven Inverse Text Normalization, Szu-Jui Chen, \textbf{Debjyoti Paul}, Yutong Pang, Peng Su, Xuedong Zhang. \textit{} \href{https://www.isca-speech.org/archive/interspeech_2023/chen23s_interspeech.html}{\emph{Interspeech 2023}, Dublin, Ireland, August 2023.}
...
\begin{innerlist}
\item[\textbf{[2016-2023]}] Reviewer: ISCA Interspeech (2023, 2024), ICASSP (2023, 2024), IEEE ICDE 2021, PVLDB (2019, 2021), IEEE TKDE (2018, 2019, 2020),  EDBT 2016,
...
%\item[\textbf{[2013]}] Ranked 3rd out of 39 M.Tech students of CSE department in Indian of Institute Technology, Kanpur
% \item[\textbf{[2015-2020]}] \textbf{Ph.D. Fellowship} at University of Utah.
\item[\textbf{[2012]}]  Secured \textbf{All India Rank 228} out of 160,000+ (99.85 percentile) participants in Graduate Aptitude Test for Engineering (GATE) 2012, Computer Science. Secured \textbf{All India Rank 223} out of 150,000+ participants in Graduate Aptitude Test for Engineering (GATE) 2011, Computer Science.
