...
\begin{document}
\makeheading{\Large{Debjyoti Paul} {\color{blue}\small\hspace{11.2cm} Updated January, 2021}}
% \vspace{-1cm}
%
% \vspace{.3cm}
...
% \end{tabular}
\begin{tabular}[t]{@{}p{\textwidth-\rcollength }p{\rcollength}}
\faEnvelope ~ \href{mailto:debjyotipaul385@gmail.com}{\url{debjyotipaul385@gmail.com}}  & \faHome ~ \href{http://www.debjyotipaul.in}{\url{www.debjyotipaul.in}}  \\
        % Salt Lake City   & \faEnvelope ~ \href{mailto:deb@cs.utah.edu}{\url{deb@cs.utah.edu}}\\
...
Representation Learning, Language Translation, Sentiment Analysis, Natural Language Processing, Social Media Analysis, Spatio-Temporal Data, Public Health Analysis
%
...
\textbf{[March 2020 - \textit{Current}] Facebook, Inc., Research Scientist}, Menlo Park, United States
\vspace{-2mm}
\begin{outerlist}
\item[] Working in the AI Speech team responsible for creating, improving, and deploying Automated Speech Recognition (ASR) models.
\end{outerlist}
\vspace{1mm}
...
\\
\begin{bibsection}
\item[+] Semantic Embedding for Regions of Interest, \textbf{Debjyoti Paul}, Feifei Li, Jeff M. Phillips, \emph{The International Journal on Very Large Data Bases (VLDBJ 2021).} \textit{DOI:} \href{https://doi.org/10.1007/s00778-020-00647-0}{10.1007/s00778-020-00647-0} \href{https://doi.org/10.1007/s00778-020-00647-0}{[PDF]}
\item[+] Database Workload Characterization with Query Plan Encoders, \textbf{Debjyoti Paul}, Jie Cao, Feifei Li, Vivek Srikumar, [In Review]
...
\begin{innerlist}
\item[\textbf{[2021]}] PC Member: ICDE 2021 Industrial Track.
\item[\textbf{[2018-2021]}] Reviewer: IEEE TKDE 2018, IEEE TKDE 2019, ICDE 2021, PVLDB 2021.
...
\item[\textbf{[2012]}] \textbf{All India Rank 7} in Indian Space Research Organization (ISRO) Junior Research Fellow Exam.
\item[\textbf{[2011]}]  Secured \textbf{All India Rank of 7} in Indian Space Research Organization (ISRO)'s Junior Research Fellow exam out of 200,000+ candidates.
\item[\textbf{[2012]}]  Secured \textbf{All India Rank 223} out of 160,000+ participants and \textbf{All India Rank 228} out of 150,000+ participants in in Graduate Aptitude Test for Engineering (GATE) in 2011 and 2012 respectively in Computer Science.
% \item[\textbf{[2011, 2012]}] Graduate Aptitude Test for Engineering (GATE), Computer Science: \textbf{99.96\%tile and 99.98\%tile.}
% \item[\textbf{[2011]}]  Achieved All India Rank of 7 in Indian Space Research Organization (ISRO) recruitment exam for Junior Research Fellow among 0.2 million candidates.
%\item[\textbf{[2010]}] 2nd Rank in Manual Robo-race competition \& 2nd Rank in Robo-Olympic an innovative track based racing competition in Bits to Bytes Tech-fest, Bengal Institute of Technology.
\end{innerlist}
