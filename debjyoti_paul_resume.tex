...
130 S 800 E APT 101  & \faHome ~ \href{http://www.cs.utah.edu/~deb}{\url{www.cs.utah.edu/\~deb}}  \\
        ...
        Pin: 84102  &  \faLinkedin ~ \href{https://www.linkedin.com/in/debjyotipaul385/}{\url{/in/debjyotipaul385/}} \\
        University of Utah & \faGithub ~ \href{https://github.com/debjyoti385}{\url{www.github.com/debjyoti385}} \\
        USA     &  \faPhone ~ \texttt{+1 385 313-7219} \\
\end{tabular}
...
\section{ Education}
%
[2015-2019] \textbf{PhD.,} \href{http://www.cs.utah.edu/}{\textbf{University of Utah, School of Computing}},
Salt Lake City, UT, USA\\
\vspace{-2mm}
\hspace{0.25cm}
\begin{tabular}[t]{@{}p{35pt}p{\rcollength+200pt}}
...
[2011-2013] \textbf{Masters of Technology,} \href{http://www.iitk.ac.in/}{\textbf{Indian Institute of Technology Kanpur}},
Kanpur, INDIA\\
\vspace{-2mm}
\hspace{0.25cm}
\begin{tabular}[t]{@{}p{35pt}p{\rcollength+200pt}}
...
[2007-2011] \textbf{Bachelors of Technology}, \href{http://www.wbut.ac.in/}{\textbf{West Bengal University of Technology}},  Kolkata, INDIA
\vspace{-2mm}
\hspace{0.25cm}
\begin{tabular}[t]{@{}p{35pt}p{\rcollength+200pt}}
        Major   &: \href{http://cse.iitk.ac.in/}{\em Computer Science \& Engineering} \\
...
\vspace{-2mm}
\begin{outerlist}
\item[-] Apply various Machine Learning techniques for Search Ranking improvements.
\end{outerlist}
\vspace{2mm}
...
\vspace{-2mm}
\begin{outerlist}
\item[-] Hyperparameter optimization with MxNet.
\end{outerlist}
\vspace{2mm}
...
\item[-] Created environment for Big data analytics in scalable environment, processing pipeline for batch and stream.
\end{outerlist}

\section{Theses}
[2013] M.Tech Thesis, Advisor: \href{http://www.cse.iitk.ac.in/users/ska}{Late Dr. Sanjeev Kumar Aggarwal}
\vspace{-2mm}
\begin{outerlist}
\item[] \textbf{Multi-constraint Job scheduling in Grid Computing}
\begin{innerlist}
...
\\
\begin{bibsection}
\item[+] Bursty Event Detection Throughout Histories, \textbf{Debjyoti Paul}, Yanqing Peng, Feifei Li, \emph{35th IEEE International Conference on Data Engineering (ICDE 2019)}, Macau, China, 2019 (Camera Ready).
...
\vspace{2mm}
\section{Projects \href{https://www.cs.utah.edu/~deb/\#projects}{(More.. )}}
